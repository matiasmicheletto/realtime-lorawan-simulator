...
positions = randi(map_size, eds, 2) - map_size/2;
...
hold on
scatter(MsgSF7(:,2), MsgSF7(:,3), [], 'b', 'x')
scatter(MsgSF8(:,2), MsgSF8(:,3), [], 'r', 's')
scatter(MsgSF9(:,2), MsgSF9(:,3), [], 'g', 'o')
scatter(MsgSF10(:,2), MsgSF10(:,3), [], 'k', 'o', 'filled')
scatter(MsgSF11(:,2), MsgSF11(:,3), [], 'm', '.')
scatter(MsgSF12(:,2), MsgSF12(:,3), [], 'c', 's', 'filled')
grid
